      ...
      <div class="row mt-3">
        ...
        <div class="col-12 col-md-6 col-xl-4 mt-md-0 mt-4">
          <div class="card h-100">
            <div class="card-header pb-0 p-3">
              <div class="row">
                ...
                <div class="col-md-4 text-end">
                  <a href="javascript:;" @click.prevent="editProfile()">
                    <i
            ...
            <div class="card-body p-3">
              <p class="text-sm">
                Hi, I’m {{ form.name }}, Decisions: If you can’t decide, the answer is no.
...
export default {
  ...
  methods: {
    async getProfile() {
      const res = await this.callApi("get", "/api/v1/accounts");
      if (res.status === 200) {
        this.form = res.data;
      }
    },
