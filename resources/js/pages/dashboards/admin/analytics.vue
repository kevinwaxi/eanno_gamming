            ...
            <div class="card-body p-3">
              <div class="row">
                ...
                <div class="col-4 text-end">
                  ...
                  >
                    <i
                      class="ni ni-watch-time text-lg opacity-10"
                      aria-hidden="true"
                    ></i>
                  </div>
                </div>
            ...
            <div class="card-body p-3">
              <div class="row">
                <div class="col-lg-5 col-12 text-center">
                  ...
                  <a class="btn btn-sm bg-gradient-secondary mt-4"
                    >See all referrals</a
                  >
                </div>
              ...
              <ul class="list-group">
                ...
                >
                  <div class="w-100">
                    <div class="d-flex align-items-center mb-2">
                      <a
                        class="btn btn-facebook btn-simple mb-0 p-0"
                        href="javascript:;"
                      >
                ...
                >
                  <div class="w-100">
                    <div class="d-flex align-items-center mb-2">
                      <a
                        class="btn btn-twitter btn-simple mb-0 p-0"
                        href="javascript:;"
                      >
                    ...
                    <div>
                      <div class="progress progress-md">
                        <div
                          class="progress-bar bg-gradient-dark w-40"
                          role="progressbar"
                          aria-valuenow="40"
                          aria-valuemin="0"
                          aria-valuemax="100"
                ...
                >
                  <div class="w-100">
                    <div class="d-flex align-items-center mb-2">
                      <a
                        class="btn btn-reddit btn-simple mb-0 p-0"
                        href="javascript:;"
                      >
                ...
                >
                  <div class="w-100">
                    <div class="d-flex align-items-center mb-2">
                      <a
                        class="btn btn-youtube btn-simple mb-0 p-0"
                        href="javascript:;"
                      >
                ...
                >
                  <div class="w-100">
                    <div class="d-flex align-items-center mb-2">
                      <a
                        class="btn btn-slack btn-simple mb-0 p-0"
                        href="javascript:;"
                      >
