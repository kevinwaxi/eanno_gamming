            ...
            <div class="modal-body">
              ...
              <div class="row mt-3">
                ...
                <Upload
                  ...
                  ref="uploads"
                  type="drag"
                  action="/api/v1/admin/settings/inventories/categories/upload"
                  :headers="{
                    'x-csrf-token': token,
  ...
  methods: {
    ...
    async getCategories(page = 1) {
      const res = await this.callApi(
        "get",
        `/api/v1/admin/settings/inventories/categories?page=${page}
        &total=${this.total}
        &q=${this.search}
    ...
    async updateCategory(category) {
      ...
      const res = await this.callApi(
        "put",
        `/api/v1/admin/settings/inventories/categories/${category}`,
        this.form
      );
      if (res.status == 200) {
        this.closeModal();
    ...
    async deleteCategory(category) {
      ...
      if (res.status == 204) {
        ...
        this.checked = this.checked.filter((id) => id != category);
    ...
    async deleteImage(editMode = false) {
      ...
      const res = await this.callApi(
        "post",
        "/api/v1/admin/settings/inventories/categories/deleteFile",
        {
          image_name: image,
        }
      );
