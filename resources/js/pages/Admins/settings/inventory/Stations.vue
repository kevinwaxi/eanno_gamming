            ...
            <div class="card-body p-3 position-relative">
              <div class="row">
                <div class="col-7 text-start">
                  ...
                  <span
                    class="text-sm text-end text-success font-weight-bolder mt-auto mb-0"
                    >+12%
              ...
              <div class="row">
                <div class="col-7 text-start">
                  ...
                  <span class="font-weight-normal text-secondary text-sm"
                    ><span class="font-weight-bolder">+$213</span> since last month</span
                  >
                </div>
                <div class="col-5">
                  <div class="dropdown text-end">
            ...
            <div class="card-header pb-0">
              <div class="row">
                <div class="col-8">
                  ...
                  <p class="mb-0" v-if="$auth.isAdmin()">Create game stations</p>
                </div>
                <div class="col-4">
                  <a
                    href="javascript:;"
              ...
              <div class="row">
                ...
                <div class="col-3">
                  ...
                  >
                    ...
                    <option v-for="(type, i) in types.data" :key="i" :value="type.id">
                      {{ type.name }}
                    </option>
                  </select>
                </div>
                      ...
                      <td>
                        <div class="d-flex px-3 py-1">
                          ...
                          <div class="d-flex flex-column justify-content-center">
                            ...
                            <p class="text-sm font-weight-bold text-secondary mb-0"></p>
                          </div>
                        </div>
                      </td>
                      <td>
...
export default {
  ...
  methods: {
    ...
    async getScreens() {
      const res = await this.callApi("get", "/api/v1/admin/settings/inventories/screens");
      if (res.status === 200) {
    ...
    async getConsoles() {
      const res = await this.callApi(
        "get",
        "/api/v1/admin/settings/inventories/consoles"
      );
      if (res.status === 200) {
    ...
    async getStations(page = 1) {
      const res = await this.callApi(
        "get",
        `/api/v1/admin/settings/inventories/stations?page=${page}
        &total=${this.total}
        &q=${this.search}
    ...
    async createStation() {
      ...
      const res = await this.callApi(
        "post",
        "/api/v1/admin/settings/inventories/stations",
        this.form
      );
      if (res.status === 200) {
