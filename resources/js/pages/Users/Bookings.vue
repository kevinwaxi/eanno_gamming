          ...
          <div class="card-header pb-0 p-3">
            <div class="row">
              ...
              <div class="col-6 text-end">
                <button class="btn btn-outline-primary btn-sm mb-0" @click="createModal">
                  Book Now
                </button>
              </div>
            </div>
              ...
              <div class="col-6">
                ...
                <Select v-model="form.station_id">
                  <Option
                    ...
                    clearable
                    filterable
                    placeholder="Choose your favorite station"
                  >
                    {{ station.name }}
                  </Option>
                </Select>
...
export default {
  ...
  methods: {
    ...
    async getGames() {
      const res = await this.callApi("get", "/api/v1/gamers/available/games");
      if (res.status === 200) {
    ...
    async getBookings(page = 1) {
      const res = await this.callApi(
        "get",
        `/api/v1/gamers/station/booking?page=${page}
        &total=${this.total}
        &q=${this.search}
    ...
    async createBooking() {
      ...
      const res = await this.callApi("post", "/api/v1/gamers/station/booking", this.form);
      if (res.status === 200) {
