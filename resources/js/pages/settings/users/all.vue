        ...
        <div class="card h-100">
          ...
          <div class="card-footer pt-0 p-3 d-flex align-items-center">
            ...
            <div class="w-40 text-end">
              <a class="btn bg-gradient-dark mb-0 text-end" href="javascript:;"
                >View all reviews</a
              >
            </div>
          </div>
              ...
              <thead>
                <tr>
                  ...
                  >
                    ...
                    <span
                      v-if="sort_direction == 'asc' && sort_field == 'username'"
                    >
                      &darr;
                    </span>
                  </th>
                ...
                >
                  ...
                  <td>
                    <div class="ms-auto text-end">
                      ...
                      >
                        <i class="fas fa-trash-restore me-2" aria-hidden="true">
                        </i>
                        Restore
                      </a>
                      <a
