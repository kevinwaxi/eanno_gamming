  ...
  <div class="collapse navbar-collapse  w-auto h-auto max-height-vh-100 h-100" id="sidenav-collapse-main">
    <ul class="navbar-nav">
        ...
        <div class="collapse" id="dashboardsExamples">
          <ul class="nav ms-4 ps-3">
            @role('super-admin|cashier')
              ...
              <li class="nav-item ">
                <router-link :to="{name:'Invitations'}" class="nav-link ">
                  <span class="sidenav-mini-icon"> S </span>
                  <span class="sidenav-normal"> Invitation Request </span>
                </router-link>
              </li>
            @endrole
          </ul>
      ...
      @hasanyrole('super-admin|cashier')
        <li class="nav-item">
          <a data-bs-toggle="collapse" href="#securityPages" class="nav-link " aria-controls="settingsPages"
          ...
          <div class="collapse " id="securityPages">
            <ul class="nav ms-4 ps-3">
              <li class="nav-item ">
        ...
        <li class="nav-item">
          <a data-bs-toggle="collapse" href="#userPages" class="nav-link " aria-controls="userPages" role="button"
            aria-expanded="false">
            <div
              class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center d-flex align-items-center justify-content-center  me-2">
              <svg width="12px" height="12px" viewBox="0 0 42 42" version="1.1" xmlns="http://www.w3.org/2000/svg"
          ...
          <div class="collapse " id="userPages">
            <ul class="nav ms-4 ps-3">
              @hasrole('super-admin|cashier')
                ...
                <li class="nav-item ">
                  <router-link :to="{name:'Cashiers'}" class="nav-link">
        ...
        <li class="nav-item">
          <a data-bs-toggle="collapse" href="#inventoryPages" class="nav-link " aria-controls="userPages"
            role="button" aria-expanded="false">
            <div
              class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center d-flex align-items-center justify-content-center  me-2">
              <svg width="12px" height="12px" viewBox="0 0 42 42" version="1.1" xmlns="http://www.w3.org/2000/svg"
          ...
          <div class="collapse " id="inventoryPages">
            <ul class="nav ms-4 ps-3">
              @hasrole('super-admin')
                <li class="nav-item ">
                  <router-link :to="{name:'Consoles'}" class="nav-link">
                    <span class="sidenav-mini-icon"> C </span>
                    <span class="sidenav-normal"> Consoles </span>
                  </router-link>
                </li>
                <li class="nav-item ">
          ...
          <ul class="nav ms-4 ps-3">
            ...
            <li class="nav-item ">
              <router-link :to="{name:'AccountSettings'}" class="nav-link">
                ...
                <span class="sidenav-normal"> Edit Account </span>
              </router-link>
            </li>
          </ul>
        </div>
