          ...
          _c("div", { staticClass: "card" }, [
                  ...
                  _c(
                    ...
                    [
                      ...
                      _vm.permissions.data
                        ? _c(
                            "option",
                            { domProps: { value: _vm.permissions.meta.total } },
                            [
                              _vm._v(
                                "\n                  All " +
            ...
            _c("div", { staticClass: "table-responsive" }, [
              _c("table", { staticClass: "table align-items-center mb-0" }, [
                ...
                _c(
                  "tbody",
                  _vm._l(_vm.permissions.data, function (permission, i) {
                    return _c(
                      "tr",
                      {
                        key: i,
                              ...
                              _c("input", {
                                ...
                                domProps: {
                                  ...
                                  checked: Array.isArray(_vm.checked)
                                    ? _vm._i(_vm.checked, permission.id) > -1
                                    : _vm.checked,
                                },
                                on: {
                                  change: function ($event) {
                            ...
                            _c(
                              "a",
                              {
                                ...
                                on: {
                                  click: function ($event) {
                                    $event.preventDefault()
                                    return _vm.showDeleteModal(permission)
                                  },
                                },
                              },
                              [
                            ...
                            _c(
                              "a",
                              {
                                ...
                                on: {
                                  click: function ($event) {
                                    $event.preventDefault()
                                    return _vm.editModal(permission)
                                  },
                                },
                              },
                              [
                ...
                _c("div", { staticClass: "w-60" }, [
                  _vm.permissions.data
                    ? _c("p", { staticClass: "text-sm" }, [
                        _vm._v("\n              Showing\n              "),
                        _c("b", [_vm._v(_vm._s(_vm.permissions.meta.from))]),
                        _vm._v(" to\n              "),
                        _c("b", [_vm._v(_vm._s(_vm.permissions.meta.to))]),
                        _vm._v(" out of\n              "),
                        _c("b", [_vm._v(_vm._s(_vm.permissions.meta.total))]),
                        _vm._v(" entries\n            "),
                      ])
                    : _vm._e(),
                ]),
      ...
      _c(
        ...
        [
          ...
          _c("div", { staticStyle: { "text-align": "center" } }, [
            _c("p", [
              _vm._v("Are you sure you would like to delete this permission ?"),
            ]),
            _vm._v(" "),
